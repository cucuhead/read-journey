...
import { setCredentials, setWelcomeMessage } from '../../redux/auth/authSlice';
...
function LoginPage() {
  ...
  const onSubmit = async data => {
    try {
      ...
      dispatch(setWelcomeMessage(`Welcome back, ${response.name}!`));
            ...
            <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
              <div className={styles.fieldWrapper}>
                <div className={`${styles.inputBox} ${errors.email ? styles.inputBoxError : ''}`}>
                  ...
                  {errors.email && (
                    <span className={styles.iconError}><ErrorIcon /></span>
                  )}
                </div>
              ...
              <div className={styles.fieldWrapper}>
                <div className={`${styles.inputBox} ${errors.password ? styles.inputBoxError : ''} ${isPasswordValid ? styles.inputBoxSuccess : ''}`}>
                  ...
                  {isPasswordValid && (
                    <span className={styles.iconSuccess}><SuccessIcon /></span>
                  )}
                </div>
